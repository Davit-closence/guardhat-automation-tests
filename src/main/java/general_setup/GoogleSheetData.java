...
public class GoogleSheetData {
    ...
    private static String SPREADSHEET_ID = "1qDtYbH6WXxim9U2NW9sSNAQvLqhiPMdff-gS8SEUokE";

    private static Credential authorize() throws IOException, GeneralSecurityException {
        InputStream in = GoogleSheetData.class.getResourceAsStream("/credentials.json");
    ...
    public static String setGoogleSheetData(int index) {
        try {
